...
from .config import MES_TEST, MES_TRAIN, MES_VALIDACION, SEMILLA, STUDY_NAME
...
def evaluar_en_test(
    ...
    df_train = df_train_completo[
        df_train_completo["foto_mes"].isin(periodos_entrenamiento)
    ]
    ...
    num_boost_round = params_entrenamiento.pop(
        "num_iterations", params_entrenamiento.pop("num_boost_round", 300)
    )
